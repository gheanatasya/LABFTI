...
<body>
    ...
    @endif
        ...
        @if ($peminjamanDataRuangan != null && $peminjamanDataAlat != null)
            ...
            <p id="notes">*Harap menunjukkan file ini kepada petugas yang sedang bertugas ketika selesai menggunakan ruangan dan alat</p>
        <br>
        ...
        @elseif ($peminjamanDataAlat != null && (count($peminjamanDataRuangan)) == 0)
            ...
            <table>
                ...
                <tr>
                    <td id="tengah">1</td>
                    <td>{{ $peminjamanDataAlat[0]['tanggalawalAlat'] }} - {{ $peminjamanDataAlat[0]['tanggalakhirAlat'] }} </td>
                    <td>
                        @foreach ($peminjamanDataAlat as $booking)
                            {{ $booking['namaalat'] }}<br>
                        @endforeach
            ...
            <p id="notes">*Harap menunjukkan file ini kepada petugas yang sedang bertugas ketika selesai menggunakan alat</p>
        <br>
        ...
        @elseif ((count($peminjamanDataAlat)) == 0 && $peminjamanDataRuangan != null)
            ...
            <p id="notes">*Harap menunjukkan file ini kepada petugas yang sedang bertugas ketika selesai menggunakan ruangan</p>
        @endif
